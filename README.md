...
| `overrideKind`             | Enumerated field to create a `CronJob` or `Job` which overrides the global value. This is useful when this chart is imported multiple times in another chart to add different kinds of jobs.     | `nil`     |
