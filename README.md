...
| `disableActiveClusterCheck`| Bool to disable active cluster check. For almost all cases, this should be left false. Applicable only if kind is  `CronJob` | `False` |
